...
import {POLL_QUESTION_MAX_LENGTH, POLL_CHOICE_MAX_LENGTH ,POLL_BLOOD_GROUP_TYPE_LENGTH} from '../constants';
import './NewPoll.css';  
...
class NewPoll extends Component {
    ...
    handleSubmit(event) {
        ...
        .then(response => {
            ...
            if(error.status === 401) {
                this.props.handleLogout('/login', 'error', 'You have been logged out. Please login to donate blood or request blood.');    
            } else {
                notification.error({
                    message: 'Online Blood Bank',
    ...
    validateQuestion = (questionText) => {
        if(questionText.length === 0) {
            return {
                ...
                errorMsg: 'Please enter your request Blood!'
            }
    ...
    validateBloodGroup = (bloodgroupText) => {
        if(bloodgroupText.length === 0) {
            return {
                validateStatus: 'error',
                errorMsg: 'Please enter your request Blood Group!'
            }
        } else if (bloodgroupText.length > POLL_BLOOD_GROUP_TYPE_LENGTH) {
            return {
                validateStatus: 'error',
                errorMsg: 'Blood Group is Invalid'
            }    
        } else {
            return {
                validateStatus: 'success',
    ...
    render() {
        ...
        return (
            <div className="new-poll-container">
                <h1 className="page-title">Create Blood Request
                </h1>
                <div><b>
                    Format:<br></br>
                    Blood Group: &lt;BloodGroupNeeded&gt;<br></br>
                    Why you need Blood: &lt;YourReason&gt;<br></br>
                    Hospital Name:&lt;HospitalName&gt;<br></br>
                    Location:&lt;HospitalLocation&gt;<br></br>
                    Contact Number:&lt;ContactNumber&gt;<br></br>
                    Mail Us On:&lt;E-Mail&gt;<br></br></b>
                </div>
                <div className="new-poll-content">
                    <Form onSubmit={this.handleSubmit} className="create-poll-form">
                        ...
                        <FormItem validateStatus={this.state.bloodgroup.validateStatus}
                            help={this.state.bloodgroup.errorMsg} className="poll-form-row">
                        <Input 
                            placeholder="Blood Group"
                            style = {{ fontSize: '16px' }} 
                            autosize={{ minRows: 3, maxRows: 6 }} 
                            name = "bloodgroup"
                            value = {this.state.bloodgroup.text}
                        ...
                        <FormItem className="poll-form-row">
                            ...
                            <Col xs={24} sm={20}>    
                                ...
                                <span>
                                    ...
                                    </Select> &nbsp;Hours..<div>Please Hurry!!</div>
                                    <div><b>If You Can donate,Please Contact Us</b></div>
                                </span>
                            </Col>
                        </FormItem>
                        <FormItem className="poll-form-row">
                            <Button type="primary" 
                                ...
                                className="create-poll-form-button">Request Blood</Button>
                        </FormItem>
                    </Form>
                </div>    
            </div>
