            ...
            <div className="poll-content">
                ...
                <div className="poll-footer">
                    { 
                        ...
                        (<Button className="vote-button" disabled={!this.props.currentVote} onClick={this.props.handleVoteSubmit}>Submit</Button>) : null 
                    }
                    <span className="total-votes">{this.props.poll.totalVotes} Donaters</span>
